...
4. 拷贝代码，iOS修改build settings/Header Search Path、Build Phases/Link...、Capabilities添加push和applinks
...
7. 运行后提示没有导出组件，是因为在App.js中不需要使用AppRegistry注册应用，直接expor class就可以
8. 可以运行并且打卡登录页面，还需优化react-native-storage和react-navigation的actions
